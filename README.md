...
[八页可视化说明 →](docs/workflow-guide.html)

包含总览、工作流地图、四个技能详解、支撑能力和使用示例。下载 `docs/workflow-guide.html` 后用浏览器打开：可翻页、点击回收窗口查看说明，也可打印为 PDF。单文件内含图形、样式和交互，不依赖网络。GitHub 文件页面展示源码，不会直接运行 HTML。
...
打包日期：2026-09-10。原技能和脚本保持原字节；新增 README、流程图、八页 HTML 说明、安装器及 SHA-256 清单。相同技能的重复安装副本已核对一致，仅保留一份。
