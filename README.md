...
[工作流说明 · 15 页 →](说明文档/工作流说明.html)

包含总览、工作流地图、四个技能详解、支撑能力和使用示例。个人助理扩展为八页：七种模式、来源与判断、累计记忆、晨间六栏、周初排期、今日与日报、周月复盘与审计、写入与验收。

[个人助理 · 完整说明 →](manage-personal-work-reports/README.md)

下载 `说明文档/工作流说明.html` 后用浏览器打开：可翻页、点击回收窗口查看说明，也可打印为 PDF。单文件内含图形、样式和交互，不依赖网络。GitHub 文件页面展示源码，不会直接运行 HTML。
